...
AADAPTER_GALAGA_L08Projectile::AADAPTER_GALAGA_L08Projectile()
{
	...
	ProjectileMesh->OnComponentHit.AddDynamic(this, &AADAPTER_GALAGA_L08Projectile::OnHit);		// set up a notification for when this component hits something
...
void AADAPTER_GALAGA_L08Projectile::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
